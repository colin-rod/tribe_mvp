-- Fix Missing Likes Table Migration
-- Migration: 20250929000004_fix_missing_likes_table.sql
-- Description: Create missing likes table and comments table with proper RLS policies

-- =============================================================================
-- 1. LIKES TABLE (if missing)
-- =============================================================================
...
-- =============================================================================
-- 7. FIX RLS POLICIES FOR RESPONSES TABLE (406 ERROR FIX)
-- =============================================================================

-- Drop and recreate the responses table RLS policy to fix 406 errors
...
-- Also allow parents to insert responses (for testing/debugging)
DROP POLICY IF EXISTS "Parents can insert responses" ON responses;
CREATE POLICY "Parents can insert responses" ON responses
...
-- Fixed missing likes table and comments table, added engagement columns to updates,
-- fixed RLS policies for responses table to resolve 404/406 errors in dashboard