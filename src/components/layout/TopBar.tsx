      ...
      <div className="h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex-1 max-w-2xl mx-4 hidden md:block">
          <div className="relative">
            <input
              type="search"
              placeholder="Search updates, children, or recipients..."
              className="w-full px-4 py-2 pl-10 text-sm border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              aria-label="Search"
            />
            <svg
